...
class Property extends Model
{
  ...
  public function property_itemlink()
  {
    return $this->belongsTo('App\v1\Models\Item', 'value')
      ->without('created_by', 'updated_by', 'deleted_by', 'organization', 'properties')
      ->withTrashed();
      // ->with('properties:id,name,internalname,valuetype,unit,organization_id');
  }

  public function property_typelink()
  {
  ...
  public function property_propertylink()
  {
