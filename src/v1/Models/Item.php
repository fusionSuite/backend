  ...
  public static function boot()
  {
    ...
    static::pivotUpdating(function ($model, $relationName, $pivotIds)
    {
      foreach ($pivotIds as $propertyId)
      {
        ...
        else if (in_array($currentItemProperty->valuetype, ['typelink', 'typelinks']))
        {
        ...
        else if ($currentItemProperty->valuetype == 'list')
        {
        ...
        } else if ($currentItemProperty->valuetype == 'propertylink')
        {
