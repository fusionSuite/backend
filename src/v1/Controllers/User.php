...
final class User
{
   ...
   * @apiSuccess {Number}   itemlist.id                           The id of type (see type endpoint) for manage itemlist userparam.
   * @apiSuccess {Object}   itemlist.properties                   List of properties
   * @apiSuccess {Number}   itemlist.properties.typeId            The property id where store for what id of item manage this userparams.
   * @apiSuccess {Number}   itemlist.properties.elementsPerPage   The property id for store the default number of elements to display per page.
   * @apiSuccess {Number}   itemlist.properties.propertiesOrder   The property id for store the order to display properties.
   ...
   * @apiSuccess {Number}   itemlist.properties.typeId            The property id where store for what id of item manage this userparams.
   * @apiSuccess {Number}   itemlist.properties.mappingCols       The property id for store the columns mapping.
   * @apiSuccess {Number}   itemlist.properties.joiningFields     The property id for store what fields are joining.
   * 
  ...
  {
    $types = \App\v1\Models\Config\Type::whereIn('internalname', ['userparam.itemlist', 'userparam.item', 'userparam.csvimport', 'userparam.globalmenu', 'userparam.homepage'])->get();
