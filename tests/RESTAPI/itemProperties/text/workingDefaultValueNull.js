...
describe('itemProperties | text type | working set | default value null', function() {
  ...
  describe('create item | with text value', function() {
    common.createItemAndCheckOk(true, "test texte default\nmultiple lines..");
    common.deleteItem();
  });
  ...
  describe('update item | with text value', function() {
    common.updateItemAndCheckOk('my text');
  });
