...
describe('itemProperties | itemlinks type | working set | default value null', function () {
  ...
  describe('item, create: item id1', function () {
    ...
    it('Get the item to check value is good', function (done) {
      commonCreateItem.checkItemOkItemlinks(done, [global.itemId1]);
    });
  ...
  describe('property, update: replace with item id2', function () {
    it('update the property', function (done) {
