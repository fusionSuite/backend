...
describe('itemProperties | string type | working set | default value null', function () {
  ...
  describe('item, create: string value', function () {
    it('create a new item', function (done) {
      commonCreateItem.createItem(done, true, 'test string');
    });

    it('Get the item to check value is good', function (done) {
      commonCreateItem.checkItemOkString(done, 'test string');
    });
  ...
  describe('item, update: string value', function () {
    it('update item', function (done) {
      commonCreateItem.updateItem(done, 'my string');
    });

    it('Get the item to check value is good', function (done) {
      commonCreateItem.checkItemOkString(done, 'my string');
    });
  });
