...
describe('itemProperties | number type | null not allowed | create & update items', function () {
  describe('prepare', function () {
    ...
    it('create the property', function (done) {
      common.createProperty(done, 5, false);
    });
  ...
  describe('item, update: null value', function () {
    ...
    it('Get the item to check value is good', function (done) {
      commonCreateItem.checkItemOkNumber(done, 50);
    });
