...
describe('itemProperties | date type | working set | default value null', function () {
  ...
  describe('item, create: automatically set the current date', function () {
    it('create a new item', function (done) {
  ...
  describe('property, update: 2022-06-11', function () {
    it('update the property - type date', function (done) {
      common.updateProperty(done, '2022-06-11', 200);
    });

    it('Get the property to check value is good', function (done) {
      common.checkProperty(done, '2022-06-11');
    });
  });
