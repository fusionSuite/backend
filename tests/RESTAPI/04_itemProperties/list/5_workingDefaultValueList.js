...
describe('itemProperties | list type | working set | default value', function () {
  ...
  describe('item, create: no property', function () {
    it('create a new item', function (done) {
      commonCreateItem.createItem(done, false, 'list2');
    });

    it('Get the item to check value is good', function (done) {
      commonCreateItem.checkItemOkList(done, 'list2');
    });
  ...
  describe('item, update: list1 value', function () {
