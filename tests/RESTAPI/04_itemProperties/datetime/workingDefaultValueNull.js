...
describe('itemProperties | datetime type | working set | default value null', function() {
  ...
  describe('create item | with a rigth datetime', function() {
    common.createItemAndCheckOk(true, '2022-05-06 15:54:24');
  });
  ...
  describe('update item | with a right datetime', function() {
    common.updateItemAndCheckOk('2021-10-26 11:04:00');
  });
  ...
  describe('update the property to 2022-06-18 20:45:06', function() {
    common.updateProperty('2022-06-18 20:45:06', 200);
  });
