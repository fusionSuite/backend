...
describe('itemProperties | typelinks type | null not allowed | create & update items', function () {
  ...
  describe('item, update: null value', function () {
    ...
    it('Get the item to check value is good', function (done) {
      commonCreateItem.checkItemOkTypelinks(done, [1]);
    });
  ...
  describe('create property', function () {
    it('property, create: canbenull: false, define null by default value', function (done) {
      request
