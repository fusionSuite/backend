  ...
  it('verify audits added', function (done) {
    request
      ...
      .expect(function (response) {
        ...
        const viewNotexistsItem = response.body[2];
        ...
        const softdeleteItem = response.body[5];
        ...
        const restoreItem = response.body[6];
        ...
        const softdeleteItemBis = response.body[7];
