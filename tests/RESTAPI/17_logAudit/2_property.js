  ...
  it('verify audits added', function (done) {
    request
      ...
      .expect(function (response) {
        ...
        const createProperty = response.body[0];
        ...
        const failCreateProperty = response.body[1];
        ...
        const viewNotexistsProperty = response.body[2];
        ...
        const updateProperty = response.body[3];
        ...
        const failUpdateProperty = response.body[4];
        ...
        const softdeleteProperty = response.body[5];
        ...
        const restoreProperty = response.body[6];
        ...
        const softdeletePropertyBis = response.body[7];
        ...
        const deleteProperty = response.body[8];
        ...
        const faildeleteProperty = response.body[9];
