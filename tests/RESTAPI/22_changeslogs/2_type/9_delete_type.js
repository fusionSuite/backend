  ...
  it('check changes rows in database table - must have only 3 rows more', function (done) {
    requestDB
      ...
      .expect(function (response) {
        ...
        assert(
          is.equal(
            '{"id":' + global.typeId + ',"name":"test for a new name of the type","internalname":"typeforchanges","sub_organization":false,"modeling":"logical","tree":false,"allowtreemultipleroots":false,"unique_name":false,"created_at":"**date**","updated_at":"**date**","deleted_at":"**date**","created_by":{"id":2,"name":"admin","first_name":"Steve","last_name":"Rogers"},"updated_by":{"id":2,"name":"admin","first_name":"Steve","last_name":"Rogers"},"deleted_by":{"id":2,"name":"admin","first_name":"Steve","last_name":"Rogers"},"organization":{"id":1,"name":"My organization"}}',
            row.old_value,
          ),
