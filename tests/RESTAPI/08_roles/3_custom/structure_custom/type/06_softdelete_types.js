...
* /v1/types endpoint
*/
describe('roles | custom > structure > custom > type | soft delete type(s)', function() {
  ...
  it ('soft delete a type (error because custom allowed but second level no)', function(done) {
    request
    .delete('/v1/config/types/'+global.mytypeId)
    .set('Accept', 'application/json')
    .set('Authorization', 'Bearer ' + global.tokenUser1)
  ...
  it ('update permissions to custom softdelete types', function(done) {
    request
