...
* /v1/types endpoint
*/
describe('roles | custom > structure > custom > property | create role', function() {
  ...
  it('set permission to property to view only and activate custom of properties', function(done) {
    request
