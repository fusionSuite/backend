...
describe('roles | custom > structure > custom > role | soft delete role(s)', function () {
  it('soft delete a role, return 401', function (done) {
    request
  ...
  it('soft delete a role (error because custom allowed but second level no)', function (done) {
    request
      .delete('/v1/config/roles/' + global.myroleId)
      .set('Accept', 'application/json')
      .set('Authorization', 'Bearer ' + global.tokenUser1)
  ...
  it('update permissions to custom softdelete roles', function (done) {
    request
  ...
  it('soft delete a role', function (done) {
    request
      .delete('/v1/config/roles/' + global.myroleId)
      .set('Accept', 'application/json')
      .set('Authorization', 'Bearer ' + global.tokenUser1)
